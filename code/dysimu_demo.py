...
def test2_subplots_one_trace(outpath=None, show=True):
    ...
    optnchn1 = {1:{'chns':1,  'title':'Ch#1,bus154_fault'},
                2:{'chns':6,  'title':'Ch#6,bus154_fault'},
                3:{'chns':11, 'title':'Ch#11,bus154_fault'},
                4:{'chns':16, 'title':'Ch#16,bus154_fault'},
                5:{'chns':26, 'title':'Ch#26,bus154_fault'},
                6:{'chns':40, 'title':'Ch#40,bus154_fault'},
                }
...
if __name__ == '__main__':
    ...
    outpath  = r'C:\Python27\Ex_psse_python'
